...
3. Type `git clone git@github.com:davidklaing/vizit.git`
4. `cd vizit`
...
16. `sudo docker run -d -p 80:3838 -v ~/vizit/r-package/:/srv/shiny-server/ -v ~/vizit/docs/:/var/log/shiny-server/ lstmemery/moocshiny`

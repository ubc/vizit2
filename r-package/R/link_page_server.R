...
get_unique_page_name <- function(each_page_df){
 ...
 if(nrow(each_page_df)!=0){
          ...
          each_page_df["url_link"] <- paste0("<a href='",each_page_df$page,"'>",each_page_df$name,"</a>") 
         ...
         colnames(all_pages) <- c('Page_Description','Page_url','Page_Index','Page_Category','Pageview','Module')

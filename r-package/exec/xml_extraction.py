...
#        os.mkdir("../inst/results/{course}".format(course=course))
    ...
    with open(xml_files[0]) as xml_file:
        ...
        if problems:
            ...
            with open("../inst/data/{course}/multiple_choice_questions.json".format(course=course), 'w+') as output:
            ...
            with open("../inst/data/{course}/assessments.json".format(course=course), 'w+') as output:
                json.dump(output_dict, output)

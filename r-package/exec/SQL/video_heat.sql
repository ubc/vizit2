...
FROM
  ...
  FROM
    ...
    FROM (TABLE_QUERY(  UBCx__Climate1x__2T2016_logs,
  ...
  LEFT JOIN [ubcxdata:UBCx__Climate1x__2T2016.video_stats] AS B
  ON A.video_id = B.video_id) AS video_heat


LEFT JOIN [ubcxdata:UBCx__Climate1x__2T2016.person_course] AS person_course
